...
pub struct Effects {
    commands: Commands,
    audible: Caller<audio::SetAudible>,
    volume: Caller<audio::SetVolume>,
    brightness: Caller<display::SetBrightness>,
    connect: Caller<bluetooth::Connect>,
    disconnect: Caller<bluetooth::Disconnect>,
    play: Caller<media::Play>,
    pause: Caller<media::Pause>,
    next: Caller<media::Next>,
    launcher: Launcher,
